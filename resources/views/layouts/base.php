            ...
            <div class="container">
                <div class="row text-center py-4">
                    <div class="mx-auto w-75">
                        <a href='https://github.com/abo3adel' target="_blank" class="btn btn-outline-primary btn-brand transition mr-2">
                            <i class='fab fa-github'></i>
                        </a>
                        <a href='https://codepen.io/abo3adel' target="_blank" class="btn btn-outline-danger btn-brand transition mr-2">

                            <i class='fab fa-codepen'></i>
                        </a>
                        <a href='https://www.linkedin.com/in/ahmed-adel-30a932119/' target="_blank" class="btn btn-outline-info btn-brand transition mr-2">
                            <i class='fab fa-linkedin-in'></i>
                        </a>
                        <a href='https://fb.com/a7md200' target="_blank" class="btn btn-outline-primary btn-brand transition mr-2">
                            <i class='fab fa-facebook-f'></i>
                        </a>
                        <a href='https://wa.me/201143647417' target="_blank" class="btn btn-outline-success btn-brand transition mr-2">
